...
let handler = async(m, { conn }) => {
	...
	await delay(100)
  return conn.sendMessage(m.chat, { text: `*Hay Tante @${await m.sender.split('@')[0]}, Itu Nomor Ownerku Yang Paling Cantik Om, Jangan Di Jadikan Pelampiasanmu yah ^_^*`, mentions: [m.sender] }, { quoted: conn.p[id][0] })
  await delay(100)
