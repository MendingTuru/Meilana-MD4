...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.namabot = 'Meii-MD×፝֟͜×'
        global.wm = 'xrnaaazy_' + ' ♡ ᴋᴏᴋᴏ ᴘᴀ፝֟፝֟ɴɢᴇʀᴀɴ×፝֟͜×'
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? 'Selamat Datang Mek' : 'Sampai Jumpa Beban', action === 'add' ? '.intro' : 'Pangeran')
                        }
                    }
                }
                break
